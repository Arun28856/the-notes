        ...
        <div className="bg-black/40 backdrop-blur-md border border-[#00FF9D]/20 rounded-2xl p-8 shadow-xl">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-[#00FF9D]/10 rounded-full mb-4">
              <LogIn className="size-8 text-[#00FF9D]" />
            </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-black/40 text-base-content/70">Or continue with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-black/30 border border-[#00FF9D]/20 rounded-lg focus:outline-none focus:border-[#00FF9D]/50 text-base-content placeholder:text-base-content/40"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#00FF9D]/10 hover:bg-[#00FF9D]/20 text-[#00FF9D] border border-[#00FF9D]/30 hover:border-[#00FF9D]/50 transition-all duration-200 px-6 py-3 rounded-lg font-medium flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
          ...
          <div className="mt-6 text-center">
            <p className="text-base-content/70">
              ...
              <Link to="/" className="text-[#00FF9D] hover:text-[#00FF9D]/80 font-medium">
                Create one
              </Link>
            </p>
          </div>
